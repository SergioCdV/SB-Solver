function [tfapp, Papp, Bapp, Capp] = initial_approximation(initial, final, tau, m, mu, r0, kapp, ac, alphan1)
...
% inclination change between orbits [rad]
deltai = abs(final.i - initial.i);

% tfapp = 2*abs(sqrt(mu/final.pos(1))*(sqrt(2*initial.a/(final.a + initial.a))*(1-final.a/initial.a)+sqrt(final.a/initial.a)-1))/amax;

tfapp = sqrt(mu*(initial.a+final.a)-2*mu*sqrt(initial.a*final.a)*cos(deltai))/...
    (kapp*ac*r0*cos(alphan1)*sin(alphan1));
