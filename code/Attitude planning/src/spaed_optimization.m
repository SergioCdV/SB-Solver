...
function [C, dV, u, tf, tfapp, tau, exitflag, output] = spaed_optimization(system, initial_bcs, final_bcs, T, m, sampling_distribution, basis, n, setup)
    ...
    % Initial TOF
    tfapp = initial_tof(I, T, initial, final);
    ...
    tf = sol(end);                                          % Optimal maneuver time
