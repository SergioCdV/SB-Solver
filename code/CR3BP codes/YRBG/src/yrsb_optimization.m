...
function [C, dV, u, tf, tfapp, tau, exitflag, output] = yrsb_optimization(system, final_orbit, Sc, K, T, setup)
    ...
    tf(1) = sol(end-3);                                     % Optimal time of flight on the unstable manifold
    tf(2) = sol(end-2);                                     % Optimal time of flight on the stable manifold
