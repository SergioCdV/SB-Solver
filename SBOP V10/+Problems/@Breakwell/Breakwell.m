...
%% 1D constrained LQR %% 
% Implementation of the 1D constrained LQR transcription (Breakwell problem)

classdef Breakwell < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Breakwell(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
        ...
        [s0, sf] = BoundaryConditions(obj, initial, final, beta, params, t0, tf);
