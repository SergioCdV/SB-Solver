...
%% Planar transfer %% 
% Implementation of the low-thrust planar orbital transfer transcription

classdef Planar_transfer < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Planar_transfer(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
