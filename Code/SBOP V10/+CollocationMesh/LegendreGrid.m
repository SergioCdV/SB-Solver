...
%% Legendre quadrature object %%
% Definition of the Legendre quadrature rule and collocation grid as an
% object

classdef LegendreGrid < CollocationMesh.AbstractGrid
    
    methods 
        % Constructor 
        function [obj] = LegendreGrid(m)
            if (exist('m', 'var'))
                obj.NumberPoints = m;
            else
        ...
        function [obj] = CollocationGrid(obj)
            N = obj.NumberPoints;                       % Number of points
