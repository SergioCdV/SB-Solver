...
% Implementation of optimal low-thrust 3D orbital transfers in classical MEE coodinates %

classdef LowThrustRMEE < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = LowThrustRMEE(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
