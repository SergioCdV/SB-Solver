...
% Implementation of optimal low-thrust 3D orbital transfers in ideal MEE coodinates %

classdef LowThrustIMEE < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = LowThrustIMEE(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
