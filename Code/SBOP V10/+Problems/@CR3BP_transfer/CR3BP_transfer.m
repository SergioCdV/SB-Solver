...
% Implementation of a low-thrust rendezvous in the CR3BP

classdef CR3BP_transfer < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = CR3BP_transfer(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
