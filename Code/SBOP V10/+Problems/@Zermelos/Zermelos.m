...
%% Zermelos %% 
% Implementation of the Zermelos problem transcription

classdef Zermelos < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Zermelos(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
