...
%% StateConstrainedRoss %% 
% Implementation of the state constrained problem transcription, as described in Ross 2008

classdef StateConstrainedRoss < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = StateConstrainedRoss(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
