...
%% Magnetic detumbling %% 
% Implementation of a magnetic detumbling problem transcription

classdef MagneticDetumbling < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = MagneticDetumbling(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
