...
% Implementation of the Linear tangent steering problem transcription

classdef Lintan_steering < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Lintan_steering(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
