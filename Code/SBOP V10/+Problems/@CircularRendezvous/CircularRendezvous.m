...
%% Robot problem %% 
% Implementation of a low-thrust rendezvous using the CW model

classdef CircularRendezvous < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = CircularRendezvous(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
