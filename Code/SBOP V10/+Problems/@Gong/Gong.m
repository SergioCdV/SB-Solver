...
%% Gong %% 
% Implementation of the Gong problem transcription, as described in Ross 2008

classdef Gong < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Gong(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
