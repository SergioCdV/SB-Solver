...
%% Test 2 %% 
% Implementation of the Test 2 problem transcription, as described in Ross 2008

classdef RossTest2 < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = RossTest2(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
