...
%% Kang %% 
% Implementation of the Kang problem transcription, as described in Ross 2008

classdef Kang < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Kang(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
