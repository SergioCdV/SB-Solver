...
%% Magnetic pointing %% 
% Implementation of a magnetic pointing problem transcription

classdef MagneticPointing < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = MagneticPointing(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
