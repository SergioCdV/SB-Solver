...
%% Dido %% 
% Implementation of the Dido problem transcription, as described in Ross 2008

classdef Dido < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Dido(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
