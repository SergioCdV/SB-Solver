...
%% Test 1 %% 
% Implementation of the Test 1 problem transcription, as described in Ross 2008

classdef RossTest1 < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = RossTest1(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
