...
%% Asteroid Landing %% 
% Implementation of optimal asteroid landing transcription

classdef AsteroidLanding < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = AsteroidLanding(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
