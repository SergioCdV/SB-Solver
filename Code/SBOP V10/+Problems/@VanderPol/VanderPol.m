...
%% Van der Pol %% 
% Implementation of the forced Van der Pol oscillator

classdef VanderPol < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = VanderPol(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
