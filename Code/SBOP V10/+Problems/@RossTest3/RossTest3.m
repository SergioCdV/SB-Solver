...
%% Test 3 %% 
% Implementation of the Test 3 problem transcription, as described in Ross 2008

classdef RossTest3 < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = RossTest3(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
