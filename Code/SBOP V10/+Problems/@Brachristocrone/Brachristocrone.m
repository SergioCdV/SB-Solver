...
%% Brachristocrone %% 
% Implementation of the Brachristocrone problem transcription

classdef Brachristocrone < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Brachristocrone(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
