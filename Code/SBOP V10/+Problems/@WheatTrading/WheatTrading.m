...
%% Wheat Trading %% 
% Implementation of the Wheat Trading problem transcription in Ross

classdef WheatTrading < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = WheatTrading(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
