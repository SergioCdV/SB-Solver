...
%% Dreyfus %% 
% Implementation of the Dreyfus problem transcription, as described in Ross 2008

classdef Dreyfus < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Dreyfus(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
