...
%% Attitude Slew %% 
% Implementation of an attitude slew problem transcription

classdef AttitudeSlew < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = AttitudeSlew(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
