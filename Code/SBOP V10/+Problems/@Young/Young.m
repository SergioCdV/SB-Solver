...
%% Kang %% 
% Implementation of the Young problem transcription, as described in Ross 2008

classdef Young < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Young(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
