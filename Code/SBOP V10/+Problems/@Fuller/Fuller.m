...
%% Fuller %% 
% Implementation of the Fuller problem transcription, as described in Ross 2008

classdef Fuller < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = Fuller(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
