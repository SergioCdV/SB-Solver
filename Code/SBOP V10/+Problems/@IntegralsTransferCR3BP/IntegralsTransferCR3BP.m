...
%% CR3BP transfer problem %% 
% Implementation of a low-thrust rendezvous in the CR3BP through integrals of motion

classdef IntegralsTransferCR3BP < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = IntegralsTransferCR3BP(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
