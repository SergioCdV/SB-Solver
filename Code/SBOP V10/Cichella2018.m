...
%% Cichella 2018 %% 
% This script provides a main interface to solve Cichella's problem %
...
% Boundary conditions
S0 = 2;                    % Initial conditions
SF = 1;                    % Final conditions

% Create the problem
OptProblem = Problems.Cichella2018(S0, SF, L, StateDimension, ControlDimension);
