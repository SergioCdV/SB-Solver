...
%% State constrained ross %% 
% This script provides a main interface to solve Ross' problem %
...
% Create the problem
OptProblem = Problems.StateConstrainedRoss(S0, SF, L, StateDimension, ControlDimension);
...
uopt = [ [ones(1,length(tau)-1); zeros(1,length(tau)-1)], [0; -1] ];
