...
gamma = 1;%r0/t0^2;                % Characteristic acceleration

%% Boundary conditions
initial_coe = [r0 0 0 deg2rad(0) deg2rad(0)];                % Initial orbital elements
theta0 = deg2rad(0);
...
final_coe = [3*r0 0 deg2rad(0) deg2rad(0) deg2rad(0)];   
thetaf = deg2rad(0);
...
switch (formulation)
    ...
    case 1
        ...
        S0 = LegoKS.state_mapping(S0(1:6), true, "1"); 
        SF = LegoKS.state_mapping(SF(1:6), true, "1");
...
switch (formulation)
    ...
    case 2         
        ...
        % Compute the true trajectory in Cartesian space 
        S = LegoKS.state_mapping(C, false, "Ecc");
