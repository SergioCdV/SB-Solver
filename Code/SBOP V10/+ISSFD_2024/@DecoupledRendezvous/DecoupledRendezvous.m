...
%% Rendezvous for Active Debris Removal %% 
% Implementation of a low-thrust rendezvous using the Lawden-TS model for
% ADR missions

classdef DecoupledRendezvous < Problems.AbstractProblem 
    ...
    methods 
        % Constructor 
        function [obj] = DecoupledRendezvous(myInitial, myFinal, myDerDeg, myStateDim, myControlDim, myParams)
